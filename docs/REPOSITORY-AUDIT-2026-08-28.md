...
`abla86/azure-kubernetes-showcase`

## Audit finding

The audited period contains CI, smoke-test, FinOps, Terraform and documentation changes. Historical intent must be established from the corresponding work record rather than inferred from commit titles.
